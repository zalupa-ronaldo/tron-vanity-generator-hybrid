...
`--vulkan-keccak-test` separately exercises the first real address stage:
Keccak-256 of 256 secp256k1 public keys and their TRON payloads, checked
against the CPU. It requires Vulkan `shaderInt64`.
